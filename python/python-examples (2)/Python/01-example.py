...
##Multiple Values to multiple variables; notice that the space is 
#given after fruit-name for clarity in printing
# '+' means concatenation
...
c=2022
print(a,b,c,sep="-")
#print @ at end instead of the default newline character (\n).
